...
const { baseUrl, supplierCode, collectsPII, surveyQuotaCalcTypeID, PURE_BASE_URL, PURE_KEY, PURE_CREATESURVEY, groupSurveyUrl, Authorization, bidLengthOfInterviewLTE, surveyQualUrl, QuotaUrl } = require("../utils/common");
