...
async function createMappingDataBundle(surveyData, vendorData) {
  ...
  for (const surveyIndex of surveyData) {
    ...
    mappingDataBundle.push([studyId + vendorId, studyId, vendorId, newIDMapId, vendorSuccessUrl, vendorTerminateUrl, vendorOverQuotaUrl, vendorSecurityUrl, "", "", date, date, surveyIndex.TotalRemaining, totalQuota]);
  }
